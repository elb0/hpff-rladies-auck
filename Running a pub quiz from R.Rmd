...
This talk was about web scraping and was inspired from work I had done to get data to write a Stats 101: Introduction to Statistics exam in 2017. In this spirit of R flavoured fun we have at these meetups, I thought it would be neat to showcase some of the powers of the `rvest` package in a warm up quiz. I doubt this will catch on for your local pbu quiz, but maybe this will be of use to you in your own R-Ladies or other R themed groups.

Hit me up on [Twitter](www.twitter.com/Liza_Bolton) if you have any questions or feedback.
